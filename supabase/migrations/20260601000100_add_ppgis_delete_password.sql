...
comment on column public.submissions.delete_password_salt is
  'Private salt for the 4-digit PPGIS delete password. Do not expose in public views or frontend clients.';

comment on column public.submissions.delete_password_hash is
  'Private PBKDF2 hash for the 4-digit PPGIS delete password. Do not expose in public views or frontend clients.';
